...
export default class BuildingsContent extends React.PureComponent {
  render() {
    return (
      <Content
        title="Buildings"
      ...
      >
        ...
        <Row>
          <Col xs>
            <Tabs handleSelect={this.context.navigate} selectedTab={`${this.context.location.pathname}${this.context.location.hash}`}>
              <TabLinkList>
